...
@application_2 = Application.create!(applicant_name: 'Meredith Grey', street_address: '3463 Collin St', city: 'Denver', state: 'CO', zip_code: '80035', description: 'I love animals', status: 'In Progress')
